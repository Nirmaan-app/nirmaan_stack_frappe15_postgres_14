...
REASON = (
    ...
    "  - per-slice as-built record -> frontend/.claude/plans/boq-upload-plan.md\n"
    "    (append a '## <record title>' section; the plan doc is the single live record)\n"
    "  - design / live status -> frontend/.claude/plans/boq-upload-plan.md\n"
