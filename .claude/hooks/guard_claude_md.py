...
REASON = (
    ...
    "  - per-slice as-built record -> frontend/.claude/plans/boq/slices/<date>-<slug>.md\n"
    "    (write-once fragment + ONE row in frontend/.claude/plans/boq/_slices.md)\n"
    "  - design / live status -> frontend/.claude/plans/boq/README.md\n"
