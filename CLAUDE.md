...
**Last updated:** 2026-06-06 (Slice B1.1b-fix-B -- ReviewTree.tsx: parent column + scroll-to-parent, pill-no-clip, ancestor-only collapse, pill-above-text; tsc 0 wizard errors; Vite build exit 0) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
