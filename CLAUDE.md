...
**Last updated:** 2026-06-06 (Slice B2a-fix -- flag-(ii) tightened to rate-AND-zero-amount only (qty trigger dropped); single-open accordion + master toggle in ReviewTree; per-category flag summary strip in SheetReviewPage; 78 review-screen tests, 249 total wizard tests; tsc 0 wizard errors; Vite build exit 0) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
