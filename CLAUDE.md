...
**Last updated:** 2026-06-07 (Slice C-v1 -- optional `reason` 6th edit_log key + `edited_at` on save_review_edit return; backend delta + read-side render; review_screen tests 78->84; tsc 0 wizard errors) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
