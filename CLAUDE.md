...
**Last updated:** 2026-06-06 (Slice B2a -- advisory flags: four §6.5.3 heuristics + per-row Info marker in ReviewTree; 76 review-screen tests, 247 total wizard tests; tsc 0 wizard errors; Vite build exit 0) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
