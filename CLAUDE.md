...
**Last updated:** 2026-06-06 (Slice B1.1b-iii -- ReviewTree.tsx: Description cell split into Classification [chevron+pill, flat anchor] + text-only Description; tsc 0 wizard errors; Vite build exit 0) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
