...
**Last updated:** 2026-06-06 (Slice B2a single-source fix -- flags folded into get_review_rows; client-side computeAdvisoryFlags deleted (~87 lines); AdvisoryFlag moved to boqTypes; 77 review-screen tests, 248 total wizard tests; tsc 0 wizard errors; Vite build exit 0) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
