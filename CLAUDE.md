...
**Last updated:** 2026-06-05 (Slice B1.1a -- feat 58d2ed44; get_review_rows extended with column_descriptors; +13 tests; 50 total review-screen tests; 218 total wizard tests) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
