...
|---|---|---|---|
| BoQ Upload & Management | `feature/boq-phase-2` | `frontend/.claude/plans/boq-upload-plan.md` | Phase 2b.2 in progress (Parts A1, A2, A3a, A3b, A3c, B1 complete; Part B2 next) |
