...
**Last updated:** 2026-06-06 (Slice B1.1b-ii -- ReviewTree.tsx: column-subset selector + three independent classification-visibility toggles; tsc 0 wizard errors; Vite build exit 0) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
