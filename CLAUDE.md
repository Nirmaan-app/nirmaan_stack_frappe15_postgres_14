...
**Last updated:** 2026-06-06 (Slice B2a-fix wording -- toggle "Show/Hide all notes"→"Show/Hide all flags"; strip label "Advisory:"→"Flags:"; text-only; tsc 0 wizard errors; Vite build exit 0) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
