...
**Last updated:** 2026-06-07 (Slice B2c -- new "Status" column [after Excel Row, green "Edited" badge / blank on original], green row tint on edited rows, provenance rule [edited_at non-null OR edit_log non-empty], totalCols 6→7, detail panel edit-focused reshape [value block removed], panel badge amber→green; tsc 0 wizard errors; Vite build exit 0) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
