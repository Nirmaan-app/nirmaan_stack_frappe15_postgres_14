...
**Last updated:** 2026-06-05 (Slice B1 review-screen spine -- feat 0683f7b9; SheetReviewPage + ReviewTree + get_structural_breaks endpoint + 3 tests; 37 total review-screen tests; 205 total wizard tests) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
