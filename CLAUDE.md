...
|---|---|---|---|
| BoQ Upload & Management | `feature/boq-phase-2` | `frontend/.claude/plans/boq-upload-plan.md` | Phase 2c — keyword expansion complete (§9 #44 CLOSED, 49→120 entries + _is_reserved normalization); 205 tests passing; caveats #2 + #4 cleanup next |
