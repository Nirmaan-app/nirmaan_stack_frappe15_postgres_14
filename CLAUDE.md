...
**Last updated:** 2026-06-06 (Slice B1.1b-fix-A -- flatten_resolved_row now writes BOTH parent_index=-1 (roots) AND human_parent=-1 (all parsed rows) per agreement #54; 60→63 parse-run tests) **Frontend conventions file: `frontend/CLAUDE.md` (NOT `frontend/.claude/CLAUDE.md`).**
