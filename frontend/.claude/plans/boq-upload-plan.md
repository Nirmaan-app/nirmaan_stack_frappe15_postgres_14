...
**Owner:** Internal team.
**Last updated:** 2026-05-14 (Part B2f complete — zero-children PREAMBLE demotion post-pass in `hierarchy.py`; Snitch Electrical LINE_ITEM=176, PREAMBLE=43; Snitch Light Fixtures PIR row demoted to LINE_ITEM (leaf+unit='NOS'); 190 tests total, 190 passing).
**Active branch:** `feature/boq-phase-2` (branched from `feature/boq-phase-1`)
**Latest commit:** Part B2f feat + docs commits (see git log).
