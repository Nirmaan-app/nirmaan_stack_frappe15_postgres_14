...
**Owner:** Internal team.
**Last updated:** 2026-06-02 (Module 3 batched UI-fixes Part 1: Finding #1 top-header conditional subform + Finding #2 data-start restyle + Finding #5 unmapped-column warning)
...
**Latest commit:** bdf32e37 feat(boq): Module 3 batched UI-fixes Part 1 -- S1 top-header conditional subform + data-start restyle + S3 unmapped warning
