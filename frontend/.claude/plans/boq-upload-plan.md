...
**Owner:** Internal team.
**Last updated:** 2026-06-01 (Slice 3d-ii read-back fix: seed loop must parse {role,area} objects + initialized-flag hardening)
...
**Latest commit:** cbb704ce fix(boq): Section 3 read-back -- seed parses {role,area} objects + no-lock-on-empty
