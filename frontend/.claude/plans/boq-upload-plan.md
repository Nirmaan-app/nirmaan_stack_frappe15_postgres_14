...
**Owner:** Internal team.
**Last updated:** 2026-06-02 (Module 3 batched UI-fixes Part 3: Finding #4 role helper text + #5 copy fix -- closes batched UI-fixes slice)
...
**Latest commit:** 25ed4b48 feat(boq): Section-3 role helper text + unmapped-warning copy fix -- Part 3
...
**Carry forward:** 3e (work-package assignment UI) and 3f (two-layer review gate) remain in Module 3.
...
1. **HELPER TEXT:** Open any sheet spoke page. Section 3 should show a small muted-foreground paragraph below the "Section 3 -- Column Roles" heading listing the three pairs. Verify it appears at full opacity even when the column_role_map sparkle is active.
