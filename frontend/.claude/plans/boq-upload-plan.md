...
**Owner:** Internal team.
**Last updated:** 2026-06-01 (Section 3 per-area uniqueness: disable used role+area pairs in area dropdown)
...
**Latest commit:** f541e428 fix(boq): Section 3 -- enforce per-area uniqueness (disable used role+area pairs)
