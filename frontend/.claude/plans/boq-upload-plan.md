...
**Owner:** Internal team.
**Last updated:** 2026-06-01 (Slice 3d-i: lift preview fetch + column_role_map state to SheetSpokePage)
...
**Latest commit:** 0c297e24 refactor(boq): lift preview fetch + column_role_map state to SheetSpokePage
