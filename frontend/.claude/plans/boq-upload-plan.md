...
**Owner:** Internal team.
**Last updated:** 2026-05-23 IST (Bill Of Quantities Electrical & ELV rows 4-22 audit script added — feat 3b0790f0; 0/19 rows differ current vs Approach A in range; parser tests unchanged 440)
**Active branch:** `feature/boq-phase-2` (branched from `feature/boq-phase-1`)
**Latest commit:** Bill Of Quantities rows 4-22 audit script — feat `3b0790f0` + docs `[hash pending — fix in next housekeeping cycle]` (see git log).
