...
**Owner:** Internal team.
**Last updated:** 2026-05-23 IST (Approach A-reframed land feat 8f960a2b; Rule A1 + A2-reframed in hierarchy.py; parser tests 440->464; Phase 2c next unblocked)
**Active branch:** `feature/boq-phase-2` (branched from `feature/boq-phase-1`)
**Latest commit:** Approach A-reframed land — feat `8f960a2b` + docs see git log.
