...
//                               (Tendering or Lost) records. A newly-won project
//                               starts at "Won" (v3.1: Won-as-initial execution stage).
...
export type ExecutionStatus =
  ...
  | "WIP"
  | "Completed"
  | "Created" // @deprecated legacy fallback (pre-v3.1 rows); never newly written
  | "Halted"
  | "Handover"
  | "CEO Hold";
