                        ...
                        <CardHeader className="w-full">
                            ...
                            <div className='flex-1'>
                                ...
                                {orderData?.procurement_list?.list.map((item)=>{
                                    if(item.category === cat.name){return <div className="py-2 text-sm px-2 font-semibold border-b">
                                        {item.item}
                                    </div>}
                                })}
                            ...
                            {selectedCategories[curCategory]?.map((item)=>{
                                ...
                                return <div className='flex-1'>
                                    <div className="truncate bg-gray-200 font-semibold p-2"><input className="mr-2" type="radio" id={item} name="group" value={item} onChange={handleChangeWithParam(cat.name,item)} />{getVendorName(item)}</div>
