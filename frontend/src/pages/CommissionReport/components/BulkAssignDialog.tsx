// frontend/src/pages/ProjectCommissionReportType/components/BulkAssignDialog.tsx

import React, { useMemo, useState } from 'react';
import { CommissionReportTask, AssignedDesignerDetail } from '../types';
