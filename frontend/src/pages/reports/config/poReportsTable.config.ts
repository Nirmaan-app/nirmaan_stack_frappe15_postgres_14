...
export const PO_REPORTS_SEARCHABLE_FIELDS: SearchFieldOption[] = [
    ...
    { value: "vendorName", label: "Vendor Name", placeholder: "Search by Vendor...", default: true },
    // Add originalDoc.status if you want to search by PO status string
];

export const PO_REPORTS_DATE_COLUMNS: string[] = ["creation", "dispatch_date", "expected_delivery_date", "latest_delivery_date", "latest_payment_date"];