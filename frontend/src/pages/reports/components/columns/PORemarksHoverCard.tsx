...
import { usePORecentRemarks, getSubjectBadgeClass, PORemarkData } from "@/pages/ProcurementOrders/purchase-order/hooks/usePORemarks";

interface PORemarksHoverCardProps {
    poId: string;
}

export const PORemarksHoverCard: React.FC<PORemarksHoverCardProps> = ({ poId }) => {
    const [isOpen, setIsOpen] = useState(false);
    const { remarks, total, isLoading } = usePORecentRemarks(poId, isOpen);
...
export default PORemarksHoverCard;
