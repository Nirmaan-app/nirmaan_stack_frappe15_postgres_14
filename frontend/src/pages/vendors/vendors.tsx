    ...
    () => [
      {
        accessorKey: "name",
        header: ({ column }) => {
          return <DataTableColumnHeader column={column} title="Vendor ID" />;
        },
        cell: ({ row }) => {
          return (
            <div className="font-medium">
              <Link
                ...
                to={`/vendors/${row.getValue("name")}`}
              >
                {row.getValue("vendor_type") === "Material" ? "M" : "S"}-
      ...
      },
      {
        ...
        header: ({ column }) => {
          return <DataTableColumnHeader column={column} title="Vendor Type" />;
        },
        cell: ({ row }) => {
          return (
            <div className="font-medium">{row.getValue("vendor_type")}</div>
          );
        },
      },
      {
        ...
        header: ({ column }) => {
          return <DataTableColumnHeader column={column} title="Vendor Email" />;
        },
        cell: ({ row }) => {
          return (
              ...
              <div>
                ...
                <HoverCard>
                  <HoverCardTrigger asChild>
                    <Button className="m-0.5 h-5" variant="outline">
