...
// v3: `status` is now the pure execution lifecycle — Won/Tendering/Lost live
// on `tendering_status` (the bid dimension). "Created" is the post-convert
// initial execution stage.
const PROJECT_STATUS_OPTIONS = ["Created", "WIP", "Completed", "Halted", "Handover", "CEO Hold"].map(
  (s) => ({ label: s, value: s })
);
