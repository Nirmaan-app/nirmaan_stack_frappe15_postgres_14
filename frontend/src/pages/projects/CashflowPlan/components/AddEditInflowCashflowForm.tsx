    ...
    const handleSubmit = async () => {
        ...
        try {
            if (initialData) {
                ...
                toast({ title: "Success", description: "Created inflow plan." });
            }
            onSuccess();
            onClose();
        } catch (e) {
            ...
            <DialogContent className="sm:max-w-[600px] p-0 gap-0 overflow-hidden bg-white">
                <DialogHeader className="px-6 py-4 border-b bg-white">
                    <DialogTitle className="text-lg font-semibold text-gray-900">
                        {initialData ? "Edit Inflow Plan" : "Add Inflow Plan"}
                    </DialogTitle>
                    <p className="text-sm text-gray-500 mt-1">
                        {initialData ? "Update plan details" : "Record anticipated inflow"}
                    </p>
                </DialogHeader>
                ...
                <div className="p-6 space-y-6">
                    <div className="space-y-2">
                        ...
                        <Textarea
                            placeholder="Enter remarks about this inflow"
                            value={remarks}
