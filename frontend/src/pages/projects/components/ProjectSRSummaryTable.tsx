...
export const ProjectSRSummaryTable: React.FC<ProjectSRSummaryTableProps> = ({ projectId }) => {
    ...
    const columns = useMemo<ColumnDef<ServiceRequests>[]>(() => [
                ...
                return (
                    <div className="font-medium flex items-center gap-1 group">
                        ...
                        <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                            <ItemsHoverCard parentDocId={sr} parentDoctype="Service Requests" childTableName="service_order_list" isSR />
                        </div>
                    </div>
                );
            }, size: 150,
        ...
        {
            accessorKey: "creation", header: ({ column }) => <DataTableColumnHeader column={column} title="SR Creation Date" />,
