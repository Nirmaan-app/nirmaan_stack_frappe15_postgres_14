...
// ProjectMaterialUsageTab.tsx (final version)
...
export const ProjectMaterialUsageTab: React.FC<ProjectMaterialUsageTabProps> = ({ 
  ...
  const { materialUsageItems, isLoading, error } = useMaterialUsageData(projectId, projectPayments);
  ...
  // Empty state
  if (materialUsageItems.length === 0) {
    return <div className="p-4 text-center text-muted-foreground">No material usage data found for this project.</div>;
  }
