...
export const TASK_STATUS_OPTIONS = [
    ...
    { label: "Drawings Awaiting from Client", value: "Drawings Awaiting from Client" },
...
export const SUB_STATUS_MAP = {
    "Clarification Awaiting": [
        "Clarification from client",  // ✅ Fixed: lowercase 'c' to match SUB_STATUS_OPTIONS
        "Clarification from Shanu"
    ],
    "Revision Pending": "__CUSTOM_TEXT__" // Special marker for custom text input
};
