...
// import { TaskWiseTable } from "./components/TaskWiseTable"; // Assuming path: ./components/TaskWiseTable.tsx
...
//     // Helper to robustly get designer details from the potentially stringified JSON field
//     const getDesigners = (designerField: AssignedDesignerDetail[] | string | undefined): AssignedDesignerDetail[] => {
...
//     return (
//         <div className="mt-4 space-y-4 px-1 py-2">
...
//                     <Plus className="h-4 w-4" /> Track New Project
//                 </Button>
//             </header>
...
//                                                 <div className="w-full md:w-1/4 min-w-[150px] pr-4 order-1 mb-2 md:mb-0">
//                                                     <Link 
...
//                                                 {/* Row 2: Date & Status */}
//                                                 <div className="w-full md:w-auto flex flex-1 justify-between md:justify-center items-center order-2">
                                                    
//                                                     {/* Date Section */}
//                                                     <div className="text-gray-600 flex flex-col items-start md:items-center w-1/2 md:w-auto">
//                                                         <div className="text-xs text-gray-500 uppercase font-medium">Task Created On:</div>
