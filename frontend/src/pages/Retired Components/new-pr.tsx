...
const NewPR = () => {
  ...
  const {
    ...
    error: project_error,
  } = useFrappeGetDoc<ProjectsType>("Projects", id);
...
export const NewPRPage = ({
  project = undefined,
  rejected_pr_data = undefined,
  setSection,
  section,
}: NewPRPageProps) => {
  ...
  const handleAdd = (request = false) => {
    if (
      (!request && curItem && Number(quantity)) ||
  ...
  const handleResolvePR = async () => {
    try {
      ...
      toast({
        title: "Success!",
        description: `PR: ${orderData?.name} ${
          section === "edit-pr" ? "Updated" : "Resolved"
      ...
      console.log(
        `Error while ${
          section === "edit-pr" ? "updating Draft PR" : "resolving Rejected PR"
        }`,
        error,
        update_error
      );
      toast({
        title: "Failed!",
        description: `${section === "edit-pr" ? "Updating" : "Resolving"} PR: ${
          orderData.name
        } Failed!`,
        variant: "destructive",
      });
            ...
            {wp_list
              ...
              ?.map((item) => (
                <Card
                  ...
                  onClick={() =>
                    handleWPClick(item.work_package_name, "categorylist")
                  }
                >
      ...
      {page == "itemlist" && (
        <div className="flex-1 space-y-2 md:space-y-4">
          <div className="flex items-center gap-1 pb-4">
            ...
            {rejected_pr_data ? (
              <div className="flex items-center justify-between w-full">
                <h2 className="text-2xl max-md:text-xl font-semibold flex items-center gap-1">
                  {section === "edit-pr" ? "Edit PR:" : "Resolve PR:"}{" "}
                  <span className="text-primary">{rejected_pr_data.name}</span>
                </h2>
                {section === "edit-pr" ? (
                  <Button
          ...
          {section === "edit-pr" && (
            <div>
              <Alert variant="warning" className="">
                ...
                <AlertDescription className="py-2 px-4">
          ...
          <div className="flex space-x-2">
            ...
            <div className="flex-1">
              <h5 className="text-xs text-gray-400">
                UOM<sup className="text-xs text-sm text-red-600">*</sup>
              </h5>
              <input
                className="h-[37px] w-[60%] border p-2 rounded-lg"
                disabled={true}
                type="text"
            ...
            <div className="flex-1">
              <h5 className="text-xs text-gray-400">
                Qty<sup className="text-xs text-sm text-red-600">*</sup>
              </h5>
              <input
            ...
            <AlertDialogContent>
              ...
              <div className="mt-4">
                ...
                <ul className="space-y-2">
                  {fuzzyMatches?.slice(0,2)?.map((item, index) => (
          ...
          <div className="flex justify-between md:space-x-0 mt-2">
            {category_list?.find((i) => i?.name === curCategory)?.new_items ===
              "false" && !["Nirmaan Admin Profile"].includes(userData?.role) ? (
              <HoverCard>
                <HoverCardTrigger asChild>
                  <Button
                    variant={"ghost"}
                    className="text-sm py-2 px-0 md:text-lg text-blue-300 flex items-center gap-1 hover:bg-white"
                    onClick={() => {
                      // setQuantity('');
                      // setCurItem('');
                      // setUnit('');
                ...
                <HoverCardContent className="max-w-[300px] bg-gray-800 text-white p-2 rounded-md shadow-lg">
                  New Item Creation is disabled for this Category, either
                  request for a new item here or contact the Administrator!
                </HoverCardContent>
              </HoverCard>
            ) : (
              <Button
            ...
            {curItem && Number(quantity) ? (
              ...
              <Button
                disabled={true}
                variant="outline"
                className="border-primary flex items-center gap-1 disabled:opacity-[30%]"
              >
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button
                disabled={
                  !orderData.procurement_list.list.length ? true : false
                }
                variant={`${
            ...
            <DialogContent className="sm:max-w-[425px]">
              ...
              <DialogClose className="hidden" id="dialogCloseforNewPR">
                Close
              </DialogClose>
            </DialogContent>
          </Dialog>
        ...
        <div className="flex-1 md:space-y-4">
          ...
          <div className="mb-4">
            ...
            <label
              ...
              className="block text-sm font-medium text-gray-700"
            >
              Item Name<sup className="pl-1 text-sm text-red-600">*</sup>
            </label>
            <Input
              type="text"
              id="itemName"
          ...
          <div className="mb-4">
            <label
              ...
              className="block text-sm font-medium text-gray-700"
            >
              Item Unit<sup className="pl-1 text-sm text-red-600">*</sup>
            </label>
            <Select onValueChange={(value) => setUnit(value)}>
              <SelectTrigger className="w-[180px]">
                <SelectValue
            ...
            <Dialog>
              <DialogTrigger asChild>
                {curItem && unit ? (
                  <Button
                    variant={"default"}
                    className="mt-15 w-full flex items-center gap-1"
                  >
              ...
              <DialogContent className="sm:max-w-[425px]">
                ...
                <DialogClose className="flex justify-center">
                  ...
                  >
                    <CheckCheck className="h-4 w-4" /> Confirm
                  </Button>
                </DialogClose>
              </DialogContent>
            </Dialog>
