 ...
 * Reason: Replaced by GenerateRFQDialog in VendorQuotesSelection
 *
 * Dependencies removed:
 * - pdfjs-dist (removed from package.json)
 *
 * If you need RFQ functionality, use:
 * - src/pages/ProcurementRequests/VendorQuotesSelection/components/GenerateRFQDialog.tsx
 */
