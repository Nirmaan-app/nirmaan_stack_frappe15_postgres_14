...
import { FrappeConfig, FrappeContext, useFrappeDocumentEventListener, useFrappeGetCall, useFrappeGetDocList, useFrappeUpdateDoc, useSWRConfig } from "frappe-react-sdk"
...
import { FrappeTargetRateApiResponse, TargetRateDetailFromAPI } from "../ApproveVendorQuotes/types"
...
export const ProcurementProgress: React.FC = () => {
  ...
  if (mainLoading && !orderData) return <LoadingFallback />;
