      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="inline-flex items-center gap-1 mt-1">
            <Badge
              variant="outline"
              className="bg-emerald-50 border-emerald-200 text-emerald-700 hover:bg-emerald-100 cursor-pointer transition-colors group"
        ...
        <TooltipContent side="bottom" className="max-w-xs">
          <div className="space-y-1 text-xs">
            ...
            <p className="text-slate-400 mt-1">Click to edit</p>
          </div>
        </TooltipContent>
      </Tooltip>
