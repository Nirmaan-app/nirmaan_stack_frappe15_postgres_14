        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            ...
            <div className="flex flex-col flex-1">
                <div className="flex items-center gap-2 mb-1">
                    ...
                    <h3 className="text-sm font-bold text-slate-800">PO Revision Impact Summary</h3>
                </div>
                <div className="text-xs text-transparent mb-2 hidden lg:block select-none tracking-widest" aria-hidden="true">&nbsp;</div>
                <div className="border rounded-md shadow-sm bg-white overflow-hidden flex flex-col flex-1">
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm text-left whitespace-nowrap min-w-[500px]">
                            ...
                            <tbody className="divide-y">
                                <tr>
                                    <td className="px-4 py-3 text-slate-800 font-medium">PO Total Excl. GST</td>
                                ...
                                <tr>
                                    <td className="px-4 py-3 text-slate-800 font-medium">PO Total Incl. GST</td>
