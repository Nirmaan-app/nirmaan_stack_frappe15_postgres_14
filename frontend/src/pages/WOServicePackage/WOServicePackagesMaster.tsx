...
export const WOServicePackagesMaster: React.FC = () => {
    ...
    const isViewOnly = ["Nirmaan PMO Executive Profile", "Nirmaan Estimates Executive Profile", "Nirmaan Billing Executive Profile", ...PROCUREMENT_PROFILES, "Nirmaan Project Lead Profile"].includes(role);
