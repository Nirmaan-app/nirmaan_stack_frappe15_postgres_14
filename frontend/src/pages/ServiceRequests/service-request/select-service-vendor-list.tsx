...
export const SelectServiceVendorList: React.FC = () => {
  ...
  const srSearchableFields = useMemo(
    () =>
      SR_SEARCHABLE_FIELDS.filter((f) => f.value !== "vendor").concat([
        {
          value: "owner",
          label: "Created By",
  ...
  const columns = useMemo<ColumnDef<ServiceRequests>[]>(
          ...
          return (
            <div className="flex justify-start items-center gap-1">
              <Button
                ...
                onClick={() => setItemToDelete(serviceRequest)}
    ...
    [projectOptions, userList, role, user_id]
  ); // Dependencies
