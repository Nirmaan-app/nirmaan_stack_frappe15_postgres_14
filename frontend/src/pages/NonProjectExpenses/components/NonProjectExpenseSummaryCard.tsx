    ...
    return (
        <div className="flex flex-wrap gap-1.5 items-center mt-2">
            ...
            {filters.map(filter => (
                <span
                    key={filter.id}
                    className="px-2 py-0.5 text-[10px] font-medium bg-rose-100 dark:bg-rose-900/40 text-rose-700 dark:text-rose-300 rounded-full capitalize"
                >
...
export default NonProjectExpenseSummaryCard;
