...
matching (#1272), and **Skip by hand with a skipped-by-hand marker (#1273)**. Still to come: Unskip,
Unreconcile for every settle path, import-created records, part-payment un-split, Confirm by hand.

As-built detail: `.claude/context/domain/outflow-import.md` § *#1271*, *#1272*, *#1273*.
...
| **Skips are final** | domain doc (several places) | a skip **by hand** can be unskipped; a system skip stays final |
